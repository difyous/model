!(function () {
            ...
            document.querySelectorAll(".navbar-nav .collapse").forEach(function (t) {
                ...
                t.addEventListener("show.bs.collapse", function (e) {
                    ...
                    t.addEventListener("hide.bs.collapse", function (e) {
                        e.stopPropagation(),
                            t.querySelectorAll(".collapse").forEach(function (e) {
    ...
    function b() {
        ...
        !a ||
            ...
            ((o = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="assets/images/logo-sm.png" alt="" height="46"></a>'),
            document
            ...
            (a = (a = "/" == location.pathname ? "/" : location.pathname.substring(1)).substring(a.lastIndexOf("/") + 1)) &&
                (!(a = document.getElementById("navbar-nav").querySelector('[href="' + a + '"]')) ||
                    ((e = a.closest(".collapse.menu-dropdown")) &&
                        ...
                        e.parentElement.closest(".collapse.menu-dropdown") &&
                            (e.parentElement.closest(".collapse").classList.add("show"), e.parentElement.closest(".collapse").previousElementSibling && e.parentElement.closest(".collapse").previousElementSibling.classList.add("active"))))),
            (document.getElementById("two-column-menu").innerHTML = o.outerHTML),
            document
                .querySelector("#two-column-menu ul")
                .querySelectorAll("li a")
                .forEach(function (a) {
                    var o = (o = "/" == location.pathname ? "/" : location.pathname.substring(1)).substring(o.lastIndexOf("/") + 1);
                    a.addEventListener("click", function (e) {
                        ...
                        (o != "/" + a.getAttribute("href") || a.getAttribute("data-bs-toggle")) && document.body.classList.contains("twocolumn-panel") && document.body.classList.remove("twocolumn-panel"),
                            ...
                            ((e.target && e.target.matches("a.nav-icon")) || (e.target && e.target.matches("i"))) &&
                                ...
                                (e = (e.target.matches("i") ? e.target.closest("a") : e.target).getAttribute("href").slice(1)),
                                document.getElementById(e) && document.getElementById(e).parentElement.classList.add("twocolumn-item-show"));
                    }),
                        o != "/" + a.getAttribute("href") ||
                            a.getAttribute("data-bs-toggle") ||
                            (a.classList.add("active"), document.getElementById("navbar-nav").classList.add("twocolumn-nav-hide"), document.querySelector(".hamburger-icon").classList.add("open"));
                }),
            "horizontal" !== document.documentElement.getAttribute("data-layout") &&
                ((e = new SimpleBar(document.getElementById("navbar-nav"))) && e.getContentElement(), (e = new SimpleBar(document.getElementsByClassName("twocolumn-iconview")[0])) && e.getContentElement()));
    }
    function y(e) {
        if (e) {
            var t = e.offsetTop,
    ...
    function f() {
        "vertical" == document.documentElement.getAttribute("data-layout") &&
            ...
            "horizontal" == document.documentElement.getAttribute("data-layout") && L();
    }
    function h() {
        feather.replace();
        ...
        e < 1025 && 767 < e
            ? (document.body.classList.remove("twocolumn-panel"),
              "twocolumn" == sessionStorage.getItem("data-layout") &&
                  (document.documentElement.setAttribute("data-layout", "twocolumn"), document.getElementById("customizer-layout03") && document.getElementById("customizer-layout03").click(), b(), w(), g()),
            ...
            : e <= 767 &&
              ...
              "twocolumn" == sessionStorage.getItem("data-layout") && (document.documentElement.setAttribute("data-layout", "vertical"), A("vertical"), g()),
        ...
        if (e.target && e.target.matches("a.nav-link span"))
            if (0 == y(e.target.parentElement.nextElementSibling))
                e.target.parentElement.nextElementSibling.classList.add("dropdown-custom-right"),
                    ...
                    e.target.parentElement.nextElementSibling.querySelectorAll(".menu-dropdown").forEach(function (e) {
        ...
        if (e.target && e.target.matches("a.nav-link"))
            if (0 == y(e.target.nextElementSibling))
                e.target.nextElementSibling.classList.add("dropdown-custom-right"),
                    ...
                    e.target.nextElementSibling.querySelectorAll(".menu-dropdown").forEach(function (e) {
                        e.classList.add("dropdown-custom-right");
                    });
    ...
    function v() {
        document.addEventListener("DOMContentLoaded", function () {
            ...
            window.addEventListener("load", function () {
                var e;
                ("twocolumn" == document.documentElement.getAttribute("data-layout") ? w : S)(),
    ...
    function w() {
        feather.replace();
        var e,
            t = "/" == location.pathname ? "/" : location.pathname.substring(1);
        (t = t.substring(t.lastIndexOf("/") + 1)) &&
            ((e = document.getElementById("navbar-nav").querySelector('[href="' + t + '"]'))
                ? (e.classList.add("active"),
                  (t =
                      (t = e.closest(".collapse.menu-dropdown")) && t.parentElement.closest(".collapse.menu-dropdown")
                          ? (t.classList.add("show"),
                            t.parentElement.children[0].classList.add("active"),
                            t.parentElement.closest(".collapse.menu-dropdown").parentElement.classList.add("twocolumn-item-show"),
                            t.parentElement.closest(".collapse.menu-dropdown").getAttribute("id"))
                          : (e.closest(".collapse.menu-dropdown").parentElement.classList.add("twocolumn-item-show"), t.getAttribute("id"))),
    ...
    function S() {
        ...
        !(e = e.substring(e.lastIndexOf("/") + 1)) ||
            ((e = document.getElementById("navbar-nav").querySelector('[href="' + e + '"]')) &&
                (e.classList.add("active"), // Active menu here
            ...
            switch (e["data-sidebar-size"]) {
                ...
                default:
                    "sm" == sessionStorage.getItem("data-sidebar-size")
                        ? (document.documentElement.setAttribute("data-sidebar-size", "sm"), z("data-sidebar-size", "sm"), sessionStorage.setItem("data-sidebar-size", "sm"))
                        : "md" == sessionStorage.getItem("data-sidebar-size")
                        ? (document.documentElement.setAttribute("data-sidebar-size", "md"), z("data-sidebar-size", "md"), sessionStorage.setItem("data-sidebar-size", "md"))
                        : "sm-hover" == sessionStorage.getItem("data-sidebar-size")
                        ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), z("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover"))
                        : (document.documentElement.setAttribute("data-sidebar-size", "lg"), z("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"));
            }
            switch (e["data-layout-mode"]) {
                case "light":
                    z("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), localStorage.setItem("data-layout-mode", "light");
                    //if (typeof PlotCharts === "function") { PlotCharts(localStorage.getItem("data-layout-mode")); }
                    break;
                case "dark":
                    z("data-layout-mode", "dark"), document.documentElement.setAttribute("data-layout-mode", "dark"), localStorage.setItem("data-layout-mode", "dark");
                    //if (typeof PlotCharts === "function") { PlotCharts(localStorage.getItem("data-layout-mode")); }
                    break;
                default:
                  localStorage.getItem("data-layout-mode") && "dark" == localStorage.getItem("data-layout-mode")
                        ? (localStorage.setItem("data-layout-mode", "dark"), document.documentElement.setAttribute("data-layout-mode", "dark"), z("data-layout-mode", "dark"))
                        : (localStorage.setItem("data-layout-mode", "light"), document.documentElement.setAttribute("data-layout-mode", "light"), z("data-layout-mode", "light"));
            }
            switch (e["data-layout-width"]) {
                ...
                default:
                    "boxed" == sessionStorage.getItem("data-layout-width")
                        ? (sessionStorage.setItem("data-layout-width", "boxed"), document.documentElement.setAttribute("data-layout-width", "boxed"), z("data-layout-width", "boxed"))
                        : (sessionStorage.setItem("data-layout-width", "fluid"), document.documentElement.setAttribute("data-layout-width", "fluid"), z("data-layout-width", "fluid"));
            }
            switch (e["data-sidebar"]) {
                ...
                default:
                    sessionStorage.getItem("data-sidebar") && "light" == sessionStorage.getItem("data-sidebar")
                        ? (sessionStorage.setItem("data-sidebar", "light"), z("data-sidebar", "light"), document.documentElement.setAttribute("data-sidebar", "light"))
                        : (sessionStorage.setItem("data-sidebar", "dark"), z("data-sidebar", "dark"), document.documentElement.setAttribute("data-sidebar", "dark"));
            }
            ...
            a == e.value ? (e.checked = !0) : (e.checked = !1),
                e.addEventListener("change", function () {
                    document.documentElement.setAttribute(t, e.value),
                        ...
                        "data-layout" == t &&
                            ("vertical" == e.value
                                ? (A("vertical"), g(), feather.replace())
                                : "horizontal" == e.value
                                ? (A("horizontal"), feather.replace())
                                : "twocolumn" == e.value && (A("twocolumn"), document.documentElement.setAttribute("data-layout-width", "fluid"), document.getElementById("layout-width-fluid").click(), b(), w(), g(), feather.replace()));
                });
        });
    }
    function x(e, t, a, o) {
        ...
        localStorage.setItem("data-layout-mode",t)
    }
    function T() {
    ...
    sessionStorage.getItem("defaultAttribute")
        ? (((a = {})["data-layout"] = sessionStorage.getItem("data-layout")),
          ...
          (a["data-layout-mode"] = localStorage.getItem("data-layout-mode")),
          ...
          B(a))
        : ((e = document.documentElement.attributes),
          (a = {}),
          e.forEach(function (e) {
              var t;
          ...
          B(a),
          (e = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && e.click()),
        b(),
        ...
        (e = document.querySelectorAll(".light-dark-mode")) &&
            e.length &&
        ...
        document.querySelectorAll("[data-provider]").forEach(function (e) {
            ...
            "flatpickr" == e.getAttribute("data-provider")
                ? ((o = {}),
                  (t = e.attributes)["data-date-format"] && (o.dateFormat = t["data-date-format"].value.toString()),
